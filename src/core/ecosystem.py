...
from ..entities.omnivores import (
    Bear, Beaver, Hippopotamus, Elephant, WhiteRhino, Giraffe, Lion, Hyena, WildBoar, Badger, RaccoonDog, Skunk, 
...
class Ecosystem:
    ...
    LAND_PREDATORS = {"fox", "wolf", "snake", "spider", "eagle", "owl", "bear", "lion", "hyena", "wild_boar", "badger", "skunk", "coati"}
    ...
    def spawn_animal(self, species: str, position: Tuple[int, int], gender: Gender = None, is_offspring: bool = False, source: str = "natural"):
        ...
        animal_classes = {
            ...
            # 新增杂食动物
            "bear": Bear, "beaver": Beaver, "hippopotamus": Hippopotamus, "elephant": Elephant, "white_rhino": WhiteRhino, "giraffe": Giraffe, "lion": Lion, "hyena": Hyena, "wild_boar": WildBoar, "badger": Badger,
