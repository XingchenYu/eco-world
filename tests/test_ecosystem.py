...
def test_v4_world_ui_payload():
    ...
    assert "region_intro" in payload["active_region"]
    assert "region_role" in payload["active_region"]
    assert payload["map_legend"]
    ...
    assert "region_intro" in payload["region_details"]["temperate_grassland"]
    assert "region_role" in payload["region_details"]["temperate_grassland"]
    assert "route_summary" in payload["region_details"]["temperate_grassland"]
    assert "frontier_links" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_links"]
    assert "target_name" in payload["region_details"]["temperate_grassland"]["frontier_links"][0]
    assert "connection_label" in payload["region_details"]["temperate_grassland"]["frontier_links"][0]
    assert "frontier_network" in payload["region_details"]["temperate_grassland"]
    assert "branch_count" in payload["region_details"]["temperate_grassland"]["frontier_network"][0]
    assert "branches" in payload["region_details"]["temperate_grassland"]["frontier_network"][0]
    assert "frontier_operations" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_operations"]
    assert "posture" in payload["region_details"]["temperate_grassland"]["frontier_operations"][0]
    assert "route_stages" in payload["region_details"]["temperate_grassland"]["frontier_operations"][0]
    assert payload["region_details"]["temperate_grassland"]["frontier_operations"][0]["route_stages"]
    assert "frontier_campaigns" in payload["region_details"]["temperate_grassland"]
    ...
    assert payload["region_details"]["temperate_grassland"]["frontier_route_profiles"][0]["route_stage_titles"]
    assert "frontier_execution_plans" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_execution_plans"]
    assert "execution_mode" in payload["region_details"]["temperate_grassland"]["frontier_execution_plans"][0]
    assert "ready_band" in payload["region_details"]["temperate_grassland"]["frontier_execution_plans"][0]
    assert "frontier_schedule_profiles" in payload["region_details"]["temperate_grassland"]
    ...
    assert "frontier_formation_profiles" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_formation_profiles"]
    assert "formation_key" in payload["region_details"]["temperate_grassland"]["frontier_formation_profiles"][0]
    assert "active_route" in payload["region_details"]["temperate_grassland"]["frontier_formation_profiles"][0]
    assert "frontier_formation_presets" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_formation_presets"]
    assert "preset_key" in payload["region_details"]["temperate_grassland"]["frontier_formation_presets"][0]
    assert payload["region_details"]["temperate_grassland"]["frontier_formation_presets"][0]["route_order"]
    assert "frontier_activation_profiles" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_activation_profiles"]
    assert "activation_key" in payload["region_details"]["temperate_grassland"]["frontier_activation_profiles"][0]
    assert "active_route" in payload["region_details"]["temperate_grassland"]["frontier_activation_profiles"][0]
    assert "frontier_activation_feedbacks" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_activation_feedbacks"]
    assert "recommended_filter" in payload["region_details"]["temperate_grassland"]["frontier_activation_feedbacks"][0]
    assert "priority_target_id" in payload["region_details"]["temperate_grassland"]["frontier_activation_feedbacks"][0]
    assert payload["region_details"]["temperate_grassland"]["frontier_activation_feedbacks"][0]["route_priority_order"]
    assert "comparison_focus" in payload["region_details"]["temperate_grassland"]["frontier_activation_feedbacks"][0]
    assert "frontier_directive_profiles" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_profiles"]
    assert "directive_key" in payload["region_details"]["temperate_grassland"]["frontier_directive_profiles"][0]
    assert "active_route" in payload["region_details"]["temperate_grassland"]["frontier_directive_profiles"][0]
    assert "frontier_directive_previews" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_previews"]
    assert "preview_name" in payload["region_details"]["temperate_grassland"]["frontier_directive_previews"][0]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_previews"][0]["preview_stages"]
    ...
    assert "frontier_directive_decisions" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_decisions"]
    assert "decision_band" in payload["region_details"]["temperate_grassland"]["frontier_directive_decisions"][0]
    assert "frontier_directive_locks" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_locks"]
    assert "lock_band" in payload["region_details"]["temperate_grassland"]["frontier_directive_locks"][0]
    assert "frontier_directive_confirmations" in payload["region_details"]["temperate_grassland"]
    assert payload["region_details"]["temperate_grassland"]["frontier_directive_confirmations"]
    assert "confirmation_band" in payload["region_details"]["temperate_grassland"]["frontier_directive_confirmations"][0]
...
def test_v4_grassland_runtime_pressure_updates_region_health():
    ...
    assert region.ecological_pressures["birth_cycle_window_pressure_memory_pull"] > 0.0
...
def test_v4_grassland_chain_summary():
    ...
    assert grassland_chain.trophic_scores["birth_cycle_window_pressure_memory_pull"] > 0.0
    ...
    region.record_relationship_state(
        "grassland_rebalancing",
        {
            "adjustments": [
                ...
                {"effect": "birth_cycle_window_pressure_herd_support"},
                {"effect": "birth_cycle_window_pressure_apex_support"},
            ]
        },
    )
    region.record_relationship_state(
...
def test_v4_carrion_chain_summary():
    ...
    assert grassland_chain.resource_scores["birth_cycle_window_pressure_memory_pull"] > 0.0
